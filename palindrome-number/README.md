<h2>9. Palindrome Number</h2><h3>Easy</h3><hr><div bis_skin_checked="1"><p>Given an integer <code>x</code>, return <code>true</code> if <code>x</code> is palindrome integer.</p>
