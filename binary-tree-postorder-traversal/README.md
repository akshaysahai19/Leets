<h2>145. Binary Tree Postorder Traversal</h2><h3>Easy</h3><hr><div bis_skin_checked="1"><p>Given the <code>root</code> of a&nbsp;binary tree, return <em>the postorder traversal of its nodes' values</em>.</p>
